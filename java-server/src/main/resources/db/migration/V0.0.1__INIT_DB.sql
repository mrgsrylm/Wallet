...
CREATE SEQUENCE IF NOT EXISTS sequence_refresh_token START WITH 1 INCREMENT BY 5;
...
ALTER TABLE transaction_type ADD CONSTRAINT uc_transaction_type_name UNIQUE (name);
ALTER TABLE wallet ADD CONSTRAINT uc_wallet_iban UNIQUE (iban);
...
ALTER TABLE refresh_token
    ADD CONSTRAINT FK_REFRESH_TOKEN_ON_USER FOREIGN KEY (user_id) REFERENCES public."user" (id);
