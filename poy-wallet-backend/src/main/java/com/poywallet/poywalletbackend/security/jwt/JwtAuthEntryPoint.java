...
import static com.poywallet.poywalletbackend.common.Constants.UNAUTHORIZED;
import static com.poywallet.poywalletbackend.common.Constants.UNAUTHORIZED_ERROR;

/**
 * Implements AuthenticationEntryPoint interface that is used for catching authentication errors
 */
@Slf4j(topic = "JwtAuthEntryPoint")
@Component
