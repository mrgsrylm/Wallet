...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationFilter(JwtService jwtService, UserDetailsServiceImpl userDetailsService, JwtRefreshRepository jwtRefreshRepository) {
...
//            var isTokenValid = jwtRefreshRepository.findByToken(jwt)
